                ...
                <section className="mt-16 rounded-lg bg-slate-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                    ...
                    <div className="mt-10">
                             <button
                                    ...
                                    className='w-full rounded-md border border-transparent bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm transition-all hover:bg-indigo-700 cursor-pointer'>
                                    Checkout
                             </button>
                    </div>         
                </section>
