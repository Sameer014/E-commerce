				...
				{isLoading ? (
					...
					<div className='lg:col-span-5 lg:col-start-8'>
						...
						<button
						       ...
						       className={`mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white transition-all hover:bg-indigo-700 ${ product.countInStock === 0 &&
